...
//***REMOVED***: Le warning est valide, main doit toujours retourner int, même si c'est possible de compiler sans...
//#pragma warning (disable:4326)		

// ***REMOVED***: Pour éteindre le warning C6030: Valeur de retour ignorée : '_getch()'.	
